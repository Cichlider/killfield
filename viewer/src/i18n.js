...
export const STRINGS = {
  en: {
    ...
    modePlay: "Play",
    modeReplay: "Replay",
    replayDropTitle: "Drop a replay JSON here",
    replayDropBody: "or choose a downloaded replay",
    replayReady: (name, frames) => `${name} · ${frames.toLocaleString()} frames`,
    replaySeeking: "Seeking through the replay…",
    replayLoadFailed: "That replay could not be loaded. Use an unedited JSON downloaded from this site.",
    ...
    rankedStop: "End run",
    rankedIdle: "A ranked run records up to 200 rounds or 120,000 frames for replay verification.",
    ...
    rankedUpload: "Submit",
    rankedWatch: "Watch replay",
    rankedSubmitWatch: "Submit & watch",
  ...
  zh: {
    ...
    modePlay: "对战",
    modeReplay: "录像",
    replayDropTitle: "把录像 JSON 拖到这里",
    replayDropBody: "或选择已下载的录像",
    replayReady: (name, frames) => `${name} · ${frames.toLocaleString()} 帧`,
    replaySeeking: "正在定位录像…",
    replayLoadFailed: "无法载入这份录像。请使用从本站下载、未编辑的 JSON 文件。",
    replayProgress: "录像进度",
    reroll: "换一张迷宫 (R)",
    resetScore: "清零比分",
    ...
    rankedStart: "排位记录",
    rankedStop: "结束记录",
    rankedIdle: "排位会逐帧记录最多 200 局或 120,000 帧，榜单靠重放核验成绩。",
